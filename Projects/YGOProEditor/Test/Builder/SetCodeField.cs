...
namespace Builder
{
	...
	{	
		...
		public static VarItem[] GetSetCodeItems(Int64 value){
			...
			VarItem setCode1 = cfg.Find(item=>item.BeContainedIn(value));
			value = value >>16;
			VarItem setCode2 = cfg.Find(item=>item.BeContainedIn(value));
			value = value >>16;		
			VarItem setCode3 = cfg.Find(item=>item.BeContainedIn(value));
			value = value >>16;		
			VarItem setCode4 = cfg.Find(item=>item.BeContainedIn(value));
